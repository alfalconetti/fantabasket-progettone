...
`/watch` — mostra la lista delle aste aperte con bottoni per iniziare a seguirle. Le aste che già segui sono marcate ✅. Puoi anche usare `/watch <asta_id>` per seguire direttamente un'asta di cui conosci l'ID.
