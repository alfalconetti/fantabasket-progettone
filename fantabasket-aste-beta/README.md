...
│   ├── user.py             # Comandi utente: /me /watched /watch /lista_fa /team_detail /autocap /autoslot /silenzia
...
| `/watched` | Aste che stai seguendo (con link Offri diretto per le aste aperte) |
| `/watch` | Segui un'asta da lista interattiva; `/watch <asta_id>` per ID diretto |
...
| `/dev_firme [N]` | Ultime N firme concluse |
| `/dev_cap` | Cap e slot virtuali con aste che li occupano |
| `/dev_log [N]` | Ultime N righe di log in memoria |
